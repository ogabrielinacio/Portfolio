...
export const CertificatesArray: Certificate[] = [
  ...
  },
  {
    ...
    issuerUrl:
      'https://fullcycle.com.br/certificado/dcb6f71d-002a-4554-beb5-510f4d449147',
    issueDate: new Date(2025, 2, 28),
    category: [CertificateCategory.DevOps, CertificateCategory.Backend],
  },
  {
    title: 'Observability',
    issuer: 'Full Cycle',
    url: `${baseUrl}/FullCycle-Observabilidade.pdf`,
    issuerUrl:
      'https://fullcycle.com.br/certificado/0126897e-84bf-44e5-b610-eb755c0e6e0a',
  ...
  },
  {
    title: 'GitOps',
    issuer: 'Full Cycle',
    url: `${baseUrl}/FullCycle-GitOps.pdf`,
    issuerUrl:
      'https://fullcycle.com.br/certificado/33ffe5bc-09e6-476f-998b-367d57b56c8e',
    issueDate: new Date(2025, 1, 8),
    category: [CertificateCategory.DevOps],
  },
  {
    title: 'Service Mesh with Istio',
    issuer: 'Full Cycle',
    url: `${baseUrl}/FullCycle-Service-Mesh-Com-Istio.pdf`,
    issuerUrl:
      'https://fullcycle.com.br/certificado/00afae9f-2ef8-435b-a75a-5ec58dbed316',
    issueDate: new Date(2025, 1, 7),
    category: [CertificateCategory.DevOps],
  },
  {
    title: 'Continuous Integration',
    issuer: 'Full Cycle',
    url: `${baseUrl}/FullCycle-Integracao-continua.pdf`,
    issuerUrl:
      'https://fullcycle.com.br/certificado/fee7fb45-f7a7-458d-b5bd-a107f38580ce',
  ...
  },
  {
    ...
    issuer: 'Full Cycle',
    url: `${baseUrl}/FullCycle-Comunicacao-entre-sistemas.pdf`,
    issuerUrl:
      'https://fullcycle.com.br/certificado/cf842571-2c23-44a2-9b65-e39de6e4a1b0',
    issueDate: new Date(2024, 12, 29),
    category: [
  ...
  },
  {
    ...
    issuerUrl:
      'https://udemy-certificate.s3.amazonaws.com/pdf/UC-e10c6b03-0e09-46c8-883b-9db995223409.pdf',
  ...
  },
  {
    ...
    issuer: 'Full Cycle',
    url: `${baseUrl}/FullCycle-Fundamentos-Da-Arquitetura-De-Software.pdf`,
    issuerUrl:
      'https://fullcycle.com.br/certificado/40e9cf80-e443-4766-8f00-ac52cd55c0c1',
    issueDate: new Date(2024, 10, 17),
    category: [
      CertificateCategory.Architecture,
      CertificateCategory.Backend,
      CertificateCategory.Frontend,
